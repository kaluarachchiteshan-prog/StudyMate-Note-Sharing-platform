...
export const MOCK_USERS: UserProfile[] = [
  ...
  },
  {
    ...
    major: 'Computer Science & Symbolic Systems',
...
export const MOCK_GROUP_MESSAGES: Record<string, GroupMessage[]> = {
  'group_1': [
    ...
    },
    {
      ...
      text: 'Awesome, thanks Alex! Shall we review Question 3 from Problem Set 4 together tonight?',
      timestamp: '10:34 AM',
    },
    {
      id: 'm3',
